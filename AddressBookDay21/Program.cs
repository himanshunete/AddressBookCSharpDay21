...
namespace AddressBookDay21
{
    ...
    public class Program
    {
        ...
        public Dictionary<string, ContactDetails> contactDetailsMap;
        //  private List<List<ContactDetails>> multipleAddressBookList;
        public Dictionary<string, Dictionary<string, ContactDetails>> multipleAddressBookMap;
        public List<ContactDetails> sortedBookList;
        ...
        {
            string myFile = @"C:\Users\admin\source\repos\AddressBookDay21\AddressBookDay21\MultipleAddressBook1.txt";
        ...
        {
            string myFile = @"C:\Users\admin\source\repos\AddressBookDay21\AddressBookDay21\MulitpleAddressBook.txt";
        ...
        //UC-14 Json Serialization
        public void JsonSerialize()
        {
            try
            {
                string path = @"C:\Users\admin\source\repos\AddressBookDay21\AddressBookDay21\MultipleAddressBook.json";
                //FileStream stream = new FileStream(path, FileMode.Create))
                string jsonData3 = JsonConvert.SerializeObject(contactDetailsList);
        ...
        //UC-14 Json DeSerialization
        public void JsonDeSerialize()
        {
            string path = @"C:\Users\admin\source\repos\AddressBookDay21\AddressBookDay21\MulitpleAddressBook.json";
            string result = File.ReadAllText(path);
            //Convert ContactDetails object to JSON string formt
            ContactDetails contactDetails = JsonConvert.DeserializeObject<ContactDetails>(result);
        ...
        public void ImplementCsv()
        {
            ...
            string importFilePath = @"C:\Users\admin\source\repos\AddressBookDay21\AddressBookDay21\MultipleAddressBook.csv";
            string exportFilePath = @"C:\Users\admin\source\repos\AddressBookDay21\AddressBookDay21\MultipleAddressBook.csv";

            // writing csv file
            using (var writer = new StreamWriter(exportFilePath))
            using (var csvExport = new CsvWriter(writer, CultureInfo.InvariantCulture))
            {
                    csvExport.WriteRecords(sortedBookList); 
            }
        ...
        static void Main(string[] args)
        {
            ...
            //sportBook.WriteAFile();
            //sportBook.JsonSerialize();
